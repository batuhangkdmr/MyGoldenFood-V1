...
namespace MyGoldenFood.Controllers
{
    ...
    {
        private readonly MyGoldenFood.ApplicationDbContext.AppDbContext _context;
        private readonly PasswordHasher<MyGoldenFood.Models.User> _passwordHasher;
        private const string SECRET_KEY = "mygoldenfood22";

        public AdminController(MyGoldenFood.ApplicationDbContext.AppDbContext context)
        {
            _context = context;
            _passwordHasher = new PasswordHasher<MyGoldenFood.Models.User>();
        }
        ...
        public async Task<IActionResult> Register(string username, string password, string masterKey)
        {
            ...
            var user = new MyGoldenFood.Models.User
            {
                Username = username,
